...
<div class="container-fluid text-left">
  ...
  <form action='authenticate1.php' method='post'>
    <div class="form-group">
      ...
      <input type="text" name="email"  maxlength='50' class="form-control"  id="email" placeholder="Enter username" required>
    </div>
    <div class="form-group">
	...
	<br>
    <button type='submit' name='login_submit' value="submit" class="btn btn-success">Submit here</button>
	...
	&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
	<button type='submit'  class="btn btn-success"><a href="register.php" style="color:white">Register here</a></button>
