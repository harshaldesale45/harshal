...
<div class="container-fluid text-center">
  ...
  <a href="http://localhost/photoz/buy_insert.php" class="list-group-item">BUY</a>
  ...
  <form action="buy_insert.php" method="post">
	...
	<div class="form-group">
      ...
      <input type="text" name="search10"  maxlength='50' class="form-control"  id="search10" placeholder="Enter city (vashi,nerul,kharghar)">
    </div>
	
	<div class="form-group">
      <label for="name">BHK:</label>
      <input type="text" name="search11"  maxlength='50' class="form-control"  id="search11" placeholder="Enter bhk (1 or 2 or 3)">
    </div>
	
	<div class="form-group">
      <label for="name">Bathrooms:</label>
      <input type="text" name="search21"  maxlength='50' class="form-control"  id="search21" placeholder="Enter (1 or 2 or 3)">
    </div>
	
	
	<div class="form-group">
      <label for="name">Type:</label>
      <input type="text" name="search31"  maxlength='50' class="form-control"  id="search31" placeholder="Furnished or Unfurnished">
    </div>
