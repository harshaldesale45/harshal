...
$search = $mysqli->real_escape_string($_POST['search10']);
$search11 = $mysqli->real_escape_string($_POST['search11']);
$search21 = $mysqli->real_escape_string($_POST['search21']);
$search31 = $mysqli->real_escape_string($_POST['search31']);
$resultSete =$mysqli->query("SELECT * FROM rent WHERE city ='$search' and bhk='$search11' and bathrooms='$search21' and furniture='$search31'");
...
<div class="container-fluid text-center">
 ...
 <?php if($resultSete->num_rows > 0)
 while($row =mysqli_fetch_array($resultSete, MYSQLI_ASSOC))
	 
	 {
		 
		 $city =$row['city'];
		  $squarefit =$row['squarefit'];
