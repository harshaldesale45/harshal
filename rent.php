...
<div class="container-fluid text-center">
  ...
  <form action="d.php"method="post">
	...
	<div class="form-group">
      ...
      <input type="text" name="search"  maxlength='50' class="form-control"  id="search" placeholder="Enter city (vashi,nerul,kharghar)">
    </div>
	
	<div class="form-group">
      <label for="name">BHK:</label>
      <input type="text" name="search1"  maxlength='50' class="form-control"  id="search" placeholder="Enter bhk (1 or 2)" required>
    </div>
	
	<div class="form-group">
      <label for="name">Bathrooms:</label>
      <input type="text" name="search2"  maxlength='50' class="form-control"  id="search" placeholder="Enter (1 or 2)" required>
    </div>
	
	
	<div class="form-group">
      <label for="name">Type:</label>
      <input type="text" name="search3"  maxlength='50' class="form-control"  id="search" placeholder="Furnished or Unfurnished" requireds>
    </div>
  <button type='submit' name='submit' value="search" class="btn btn-success">Submit</button>
