...
<div class="container-fluid text-center">
  ...
  <h2>Find a home without a broker</h2>
  <form action="flatemate_insert.php" method="post">
    
	<div class="form-group">
      <label for="name">City:</label>
      <input type="text" name="searcha"  maxlength='50' class="form-control"  id="searcha" placeholder="Enter city (vashi,nerul,kharghar)" required>
    </div>
	
	<div class="form-group">
      <label for="name">BHK:</label>
      <input type="text" name="searchb"  maxlength='50' class="form-control"  id="searchb" placeholder="Enter bhk (1 or 2)" required>
    </div>
	
	<div class="form-group">
      <label for="name">Bathrooms:</label>
      <input type="text" name="searchc"  maxlength='50' class="form-control"  id="searchc" placeholder="Enter (1 or 2)" required>
    </div>
	
	
	<div class="form-group">
      <label for="name">Type:</label>
      <input type="text" name="searche"  maxlength='50' class="form-control"  id="searche" placeholder="Furnished or Unfurnished" required>
    </div>
  <button type='submit' name='submit2' value="search2" class="btn btn-success">Submit</button>
